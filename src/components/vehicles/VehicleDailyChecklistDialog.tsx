        ...
        <DialogContent className="w-[95vw] max-w-[1200px] max-h-[90vh] overflow-y-auto p-6 rounded-xl shadow-2xl bg-white">
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              ...
              <div><span className="font-medium">PLATE NO:</span> {vehicle.plateNumber}</div>
              ...
              <div><span className="font-medium">MILEAGE:</span> {mileage}</div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6 shadow-sm">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input value={vehicle.name} disabled className="mt-1 border-gray-300" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600">PLATE NO:</label>
                <Input value={vehicle.plateNumber} disabled className="mt-1 border-gray-300" />
              </div>
              <div>
